        ...
        fetch(chrome.runtime.getURL('psp-config.json'))
            ...
            .then(pspConfig => {
                if (detectedPSP) {
                    ...
                    document.getElementById("psp-description").innerHTML = "The Payment Service Provider could be determined based on the contents of the current page. Please ensure you have navigated to website's checkout page.";
